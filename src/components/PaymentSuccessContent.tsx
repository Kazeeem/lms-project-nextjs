import { ensureSubscriptionFromSessionAction } from "@/actions/subscriptions";
...
export default function PaymentSuccessContent() {
    ...
    useEffect(() => {
        ...
        const verifyPayment = async() => {
            const result = await ensureSubscriptionFromSessionAction(sessionId);
    ...
    if (status === 'completed' || status === 'pending') {
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#f5f5f5] px-4">
                <div className="w-full max-w-[580px] bg-white p-12 rounded-2xl shadow-lg text-center">
                    {/* Success Icon */}
                    <div className="w-24 -24 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6">
                    ...
                    <p className="text-gray-600 text-center mb-8 pb-4">
                        Thank you for your payment. Your transaction has now been completed successfully.
                    </p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6 mb-8 space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-gray-900 font-semibold">{sessionData.transactionId}</span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        {status === 'pending' && (
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-gray-900 font-semibold">Payment pending! Reviewing your payment.</span>
                            </div>
                        )}
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full px-5 py-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg transition-colors duration-200"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f5f5f5] px-4">
        <div className="w-full mx-w-lg bg-white rounded-exl shadow-lg p-12">
            {/* Error icon */}
